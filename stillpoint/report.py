...
def generate_session_report(
    ...
    Args:
        ...
        enabled_sections: Which sections to include. Defaults to all sections.
            Valid keys: themes_covered, goal_progress, new_disclosures,
            coping_strategies, emotional_trajectory, red_flags,
            patterns_observed, homework_assigned, clients_own_words.
